...
node_info = node_info[node_info.news_count > 1]
...
adjusted_node_size = dict([(node,  1.5 * degree+number_to_adjust_by) for node, degree in nx.degree(G)])
...
def main():
    ...
    st.markdown("""
        <div class="content-container">
            <h1 class="title">Glambda: News Node Graph</h1>
    ...
    # Sidebar
    st.sidebar.markdown("# Node Graph 📈")
