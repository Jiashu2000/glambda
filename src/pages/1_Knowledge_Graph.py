...
pos = nx.spring_layout(G, scale=20, center=(0, 0), k=0.6, iterations=20)
...
adjusted_node_size = dict(
    [(node, 2*degree+number_to_adjust_by) for node, degree in nx.degree(G)]
)
...
def main():
    ...
    # Sidebar
    # sst.sidebar.slider("Number of Clusters", 1, 20)
